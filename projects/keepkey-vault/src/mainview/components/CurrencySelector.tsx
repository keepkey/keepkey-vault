  ...
  return (
    <Box>
      ...
      <Flex
        ...
        py="1"
      >
        <Text fontSize="xs" color="kk.textSecondary">Currency</Text>
          ...
          {FIAT_CURRENCIES.map(({ code, symbol }) => {
            ...
            return (
              <Box
                ...
                lineHeight="1.3"
                textAlign="center"
                bg={active ? "kk.gold" : "rgba(255,255,255,0.06)"}
                color={active ? "black" : "kk.textPrimary"}
                border="1px solid"
                borderColor={active ? "kk.gold" : "rgba(255,255,255,0.15)"}
                cursor="pointer"
                _hover={{
                  bg: active ? "kk.goldHover" : "rgba(255,255,255,0.12)",
                  borderColor: active ? "kk.goldHover" : "rgba(255,255,255,0.3)",
                }}
      ...
      <Flex
        ...
        pt="2"
      >
        <Text fontSize="xs" color="kk.textSecondary">Number Format</Text>
        <Flex align="center" gap="1.5">
          <Text fontSize="xs" color="kk.textPrimary" fontWeight="500">
            {currentLocale.label}
          </Text>
