...
`manifest.json` tracks all known firmware and bootloader versions with their SHA-256 hashes. This is fetched from the [keepkey-vault releases.json](https://raw.githubusercontent.com/keepkey/keepkey-vault/master/firmware/releases.json) and stored locally for offline reference.
